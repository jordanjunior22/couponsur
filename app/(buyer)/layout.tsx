...
// Shared chrome for every buyer-facing tab (Accueil, Historique, Chat,
...
// than this layout imposing one blanket wrapper, because the two Chat
// rooms need an exact viewport-minus-both-bars height instead of extra
// padding on top of a scrolling page. The top bar is sticky, not fixed, so
